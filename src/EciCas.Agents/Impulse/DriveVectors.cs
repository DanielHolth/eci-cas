...
{
    /// <summary>Bucket edges for Expression()'s low/mid/high reads.</summary>
    ...
    /// <summary>Five drive vectors collapsed into three legible appraisal axes — fixed linear combinations.</summary>
    ...
    /// same three axes the reflex vocabulary draws from. Governance reads
    /// this when an exchange is blocked and nothing model-authored may be
    /// spoken, so what reaches the human at least matches how the persona
    /// currently feels rather than a canned error face.
    /// </summary>
    public string Expression()
    {
        ...
        // Raised alertness outranks warmth. Both can be high at once — a warm
