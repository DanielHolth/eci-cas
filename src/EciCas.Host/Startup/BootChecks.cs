...
internal static class BootChecks
{
    public static async Task RunAsync(WebApplication app)
    {
        ...
        SubstrateManifestValidator.Validate(substrateOptions, app.Services.GetServices<IAgent>(), [SubstrateConsolidator.AgentName, SubstrateFactExtractor.AgentName, FactPicker.AgentName, MaintenanceOptions.RebuildAgentName, EciCas.Agents.Toolkit.SettingsCapability.AgentName, EciCas.Agents.Toolkit.ToolsmithCapability.AgentName]);
